...
final class FitsTests: XCTestCase {
    ...
    func testReadTable() {
        ...
        XCTAssertEqual(hdu.table.count, 6)
        XCTAssertEqual(hdu.table[0].values.count, 7)
        XCTAssertEqual(hdu.table[1].values.count, 7)
        XCTAssertEqual(hdu.table[2].values.count, 7)
        XCTAssertEqual(hdu.table[3].values.count, 7)
        XCTAssertEqual(hdu.table[4].values.count, 7)
        XCTAssertEqual(hdu.table[5].values.count, 7)
        
        XCTAssertEqual(hdu.table[0].TFORM, TFORM.E(w: 15, d: 7))
        XCTAssertEqual(hdu.table[1].TFORM, TFORM.E(w: 15, d: 7))
        XCTAssertEqual(hdu.table[2].TFORM, TFORM.E(w: 15, d: 7))
        XCTAssertEqual(hdu.table[3].TFORM, TFORM.E(w: 15, d: 7))
        XCTAssertEqual(hdu.table[4].TFORM, TFORM.D(w: 25, d: 17))
        XCTAssertEqual(hdu.table[5].TFORM, TFORM.A(w: 8))
        
        XCTAssertEqual(hdu.table[0].TDISP, TDISP.G(w: 15, d: 7, e: nil))
        XCTAssertEqual(hdu.table[1].TDISP, TDISP.G(w: 15, d: 7, e: nil))
        XCTAssertEqual(hdu.table[2].TDISP, TDISP.G(w: 15, d: 7, e: nil))
        XCTAssertEqual(hdu.table[3].TDISP, TDISP.G(w: 15, d: 7, e: nil))
        XCTAssertEqual(hdu.table[4].TDISP, TDISP.G(w: 25, d: 16, e: nil))
        XCTAssertEqual(hdu.table[5].TDISP, TDISP.A(w: 8))
        
        XCTAssertEqual(hdu.table[0].values[0], TFIELD.E(val: 0.0000000E+00))
        XCTAssertEqual(hdu.table[0].values[1], TFIELD.E(val: 0.0000000E+00))
        XCTAssertEqual(hdu.table[0].values[2], TFIELD.E(val: 0.0000000E+00))
        XCTAssertEqual(hdu.table[0].values[3], TFIELD.E(val: 0.0000000E+00))
        XCTAssertEqual(hdu.table[0].values[4], TFIELD.E(val: 0.0000000E+00))
        XCTAssertEqual(hdu.table[0].values[5], TFIELD.E(val: 0.0000000E+00))
        
        XCTAssertEqual(hdu.table[1].values[0], TFIELD.E(val: 4.7900000E+02))
        XCTAssertEqual(hdu.table[1].values[1], TFIELD.E(val: 4.7900000E+02))
        XCTAssertEqual(hdu.table[1].values[2], TFIELD.E(val: 4.7900000E+02))
        XCTAssertEqual(hdu.table[1].values[3], TFIELD.E(val: 4.7900000E+02))
        XCTAssertEqual(hdu.table[1].values[4], TFIELD.E(val: 3.3895200E+05))
        XCTAssertEqual(hdu.table[1].values[5], TFIELD.E(val: 8.3172100E+05))
        
        XCTAssertEqual(hdu.table[4].values[0], TFIELD.D(val: 4.99471371062592860E+08))
        XCTAssertEqual(hdu.table[4].values[1], TFIELD.D(val: 4.99471371062592860E+08))
        XCTAssertEqual(hdu.table[4].values[2], TFIELD.D(val: 4.99471371062592860E+08))
        XCTAssertEqual(hdu.table[4].values[3], TFIELD.D(val: 4.99471371062592860E+08))
        XCTAssertEqual(hdu.table[4].values[4], TFIELD.D(val: 4.99471371062592860E+08))
        XCTAssertEqual(hdu.table[4].values[5], TFIELD.D(val: 4.99471371062592860E+08))
        
        XCTAssertEqual(hdu.table[5].values[0], TFIELD.A(val: "SECONDS"))
        XCTAssertEqual(hdu.table[5].values[1], TFIELD.A(val: "SECONDS"))
        XCTAssertEqual(hdu.table[5].values[2], TFIELD.A(val: "SECONDS"))
